...
class WSCXR(torch.nn.Module):
    ...
    def load(
        ...
        featuresampler=wscxr.sampler.IdentitySampler(),
        ...
        **kwargs,
        ...
        feature_aggregator = wscxr.common.NetworkFeatureAggregator(
        ...
        preprocessing = wscxr.common.Preprocessing(
        ...
        self.anomaly_scorer = wscxr.common.NearestNeighbourScorer(
            n_nearest_neighbours=anomaly_score_num_nn, nn_method=nn_method
        )

        self.anomaly_segmentor = wscxr.common.RescaleSegmentor(
